...
export default async function handler(req, res) {
  ...
  try {
    ...
    const API_USERNAME = process.env.PAYHERO_USERNAME;
    const API_PASSWORD = process.env.PAYHERO_PASSWORD;
    ...
    // Log for debugging (in production, use proper logging service)
